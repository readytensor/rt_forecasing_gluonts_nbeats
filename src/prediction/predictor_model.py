...
class Forecaster:
    ...
    def __init__(
        ...
        lags_forecast_ratio: Optional[int] = None,
        ...
        Args:
            ...
            lags_forecast_ratio (Optional[int]):
            ...
            num_stacks (int):
                ...
                Default and recommended value for generic mode: 30 Recommended value for interpretable mode: 2

            num_blocks (Optional[List[int]]):
                The number of blocks per stack. A list of ints of length 1 or 'num_stacks'.
                Default and recommended value for generic mode: [1] Recommended value for interpretable mode: [3]

            block_layers (Optional[List[int]]):
                Number of fully connected layers with ReLu activation per block.
                A list of ints of length 1 or 'num_stacks'. Default and recommended value for generic mode: [4] Recommended value for interpretable mode: [4]

            widths (Optional[List[int]]):
                Widths of the fully connected layers with ReLu activation in the blocks.
                A list of ints of length 1 or 'num_stacks'. Default and recommended value for generic mode: [512] Recommended value for interpretable mode: [256, 2048]

            sharing (Optional[List[bool]]):
                Whether the weights are shared with the other blocks per stack.
                A list of bool of length 1 or 'num_stacks'. Default and recommended value for generic mode: [False] Recommended value for interpretable mode: [True]

            stack_types (Optional[List[str]]):
                One of the following values: “G” (generic), “S” (seasonal) or “T” (trend).
                A list of strings of length 1 or 'num_stacks'. Default and recommended value for generic mode: [“G”] Recommended value for interpretable mode: [“T”,”S”]

            scale (bool): Whether to automatically scale the target values (default: true).
    ...
    def fit(
        ...
        A separate NBEATS model is fit to each series that is contained
        in the data.
